 ...
 * will not match ours — "Organisation", "Employer" and "Company Name" all mean one field — which
 * {@code HeuristicColumnMatcher} proposes an answer to, for a person to confirm. The second is that a
 * file carries columns this application has never heard of, and dropping them loses the half of the
 * list that was worth importing. Those become custom columns
