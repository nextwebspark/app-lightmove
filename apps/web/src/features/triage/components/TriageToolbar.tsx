 ...
 *
 * <p>"Add company" is that one. Strategy's equivalent takes a company out of the market; there is no
 * market behind this button, which is the point — it is how a company the export does not carry gets
 * into a mandate at all.
 */
      ...
      <div className="flex items-center gap-3 sm:ml-auto">
        ...
        {canWrite && (
          <button
            ...
            className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-[6px] border border-line bg-panel px-3 py-2 font-sans text-[13px] font-medium text-text2 transition hover:border-text3 hover:text-text"
          >
