...
/**
 * A network's own mark — LinkedIn today — drawn wherever we link out to a profile or page.
 *
 ...
 * LinkedIn publishes solid black and white. Its stated floor is 21px, which the Contact row keeps;
 * beside a name in a drawer header a mark is drawn at 16px by the product's own call, so it weighs
 * the same as the glyphs around it.
 */
