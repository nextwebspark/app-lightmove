...
export const ICONS = {
  ...
  /** A pinched four-point star — a value a document reading filled rather than a person typed. */
  sparkle: "M12 3c.6 3.6 2.4 5.4 6 6-3.6.6-5.4 2.4-6 6-.6-3.6-2.4-5.4-6-6 3.6-.6 5.4-2.4 6-6Z",
} as const;
