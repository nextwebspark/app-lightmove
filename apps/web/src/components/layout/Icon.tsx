...
export const ICONS = {
  ...
  /** The AI mark — Strategy's AI Research button, and a brief value a document reading filled. */
  sparkle:
  ...
  /** The same person with an X — a company researched with nobody suitable found. */
  userX:
    "M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M8.5 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM17.5 8.5l5 5M22.5 8.5l-5 5",
